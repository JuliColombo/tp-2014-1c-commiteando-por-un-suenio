...
t_stream * paquetizarStruct_indiceEtiquetas(t_struct_indice_etiquetas * estructuraOrigen){
	...
	paquete->length = sizeof(t_header) + sizeof(uint32_t) + sizeof(estructuraOrigen->index_etiquetas);
	...
	memcpy(data + tamanioTotal, &estructuraOrigen->index_etiquetas ,tamanioDato = sizeof(estructuraOrigen->index_etiquetas));
...
t_stream* paquetizarStruct_escribirSegmentos(t_struct_segmento* estructuraOrigen){
	...
	memcpy(data + tamanoTotal, estructuraOrigen->segmento, tamanoDato = (estructuraOrigen->tamanio));
