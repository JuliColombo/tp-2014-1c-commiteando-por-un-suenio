...
signed int* definirVariable(t_nombre_variable identificador_variable){ identificador_variable = malloc(sizeof(signed int));
									if(identificador_variable*!=NULL){return identificador_variable*;}
									else{ printf("No se puede reservar memoria");
									return NULL*;
												}
}
...
signed int dereferenciar(signed int* direccion_variable){signed int aux; //extrae el valor de la variable ubicada en direccion_variable
